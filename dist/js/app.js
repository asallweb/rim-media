    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        menuItems.forEach((function(menuItem) {
            ...
            menuLink.addEventListener("click", (function(event) {
                const submenu = menuItem.querySelector(".menu__list-sub");
                if (submenu) {
                    event.preventDefault();
                    menuItem.classList.toggle("_opened");
                }
            }));
        }));
    }));
    document.addEventListener("DOMContentLoaded", (function() {
        const toggleMenuButton = document.querySelector("._tablet-toggle-menu");
        const menuBody = document.querySelector(".menu__body");
        if (toggleMenuButton && menuBody) toggleMenuButton.addEventListener("click", (function() {
